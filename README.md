...
### This repository is Simple Trafic Light .
Each part consists of 3 LEDs to display the status.
The S1 key is to change the mode to the night mode and the S2 key is to change the mode to the day mode.
...
<p align="center">
<a href="./LICENSE.md">
<img alt="GitHub license" src="https://img.shields.io/github/license/khalilian-ah/Bascom_avr-Trafic-Light.2?style=badge">
</a>
